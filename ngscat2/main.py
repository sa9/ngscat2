...
def parse_arguments():
    usage = %prog --bams /DATA/workspace/ccg/data_carmen/cutadapt_q30_m65/S653_UKKD19070049-AK417_HGWJMDSXX.sorted.bam --bed /DATA/workspace/ccg/coverage_analysis/Exome_Exomev1_Probes.hg19.manifest.bed --out /DATA/workspace/ccg/ngscat2"""	
       	****************************************************************************************************************
